 ...
 */
public class DownThread3 implements Callable<Boolean> {

    private final String url;
    private final long beginPost;
    private final long endPost;
    public File tempFile;
    private long readCount = 0;//总字节数

    public DownThread3(String url, String fileDir, String fileName, int taskId, long beginPost, long endPost) {
        this.url = url;
